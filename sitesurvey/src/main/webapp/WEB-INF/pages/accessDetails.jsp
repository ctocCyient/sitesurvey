...
<div class="wrapper wrapper-login">
  <div class="container container-login animated fadeIn">
			...
			<form method="post" id="siteAccess" >
			<div class="login-form">			
				<div class="form-group ">
					<label for="accesstype" class="placeholder">Access Type</label>
					<input id="accesstype" class="form-control input-full"  />					
				</div>
				<div id="exchangeNewDiv">
					<div class="form-group ">
					<label for="condition" class="placeholder">Condition</label>
					<input id="condition"  class="form-control input-full"   />						
					</div>
				</div>
				<div id="exchangeExistDiv">
					<div class="form-group">
					<label for="obsrvcommnts" class="placeholder">Observations/Comments</label>
	                <input id="obsrvcommnts" name="obsrvcommnts" class="form-control input-border" />	                
	            	</div>
            	</div>
				...
				<div class="form-action" id="typeDiv">	
					...
					<input type="submit" id="submit1" value="Save & Continue" class="btn btn-rounded btn-login" style="background-color: #012169;color: white;">
