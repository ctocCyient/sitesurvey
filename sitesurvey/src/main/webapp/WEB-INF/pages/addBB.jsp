...
<div class="wrapper wrapper-login">
  <div class="container container-login animated fadeIn">
    <div align="center"><span class="isa_success" style="color:#35B234;font-size:20px">${status}</span></div>	<br><br>
			...
			<form:form action="saveSMPS" method="post" modelAttribute="Site_Battery_Bank">
			<div class="login-form">
				...
				<form:input id="type" path="type"  name="type"  class="form-control input-full filled"  />
				<br>
				...
				<label for="number_of_batteries" class="module_rating">number_of_batteries</label>
               <form:input id="number_of_batteries" path="number_of_batteries"  name="number_of_batteries"  class="form-control input-full filled"  />
                <br>
                 ...
                 <label for="fuellevel" class="fuellevel">Number of Working modules available</label>
              	...
              	<br>
              	                ...
              	                <label for="capacity" class="capacity">Condition</label>
              	 <form:input id="capacity" path="capacity"  name="capacity"  class="form-control input-full filled"  />
                <br>
              	            
              	
              	<label for="overallCondition" class="overallCondition">Overall Condition of Battery Bank Equipment</label>
